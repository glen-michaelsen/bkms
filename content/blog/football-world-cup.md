---
title: "Football & the World Cup: How to Cheer in Serbian & Croatian"
...
Croatian built its word from _noga_ (leg/foot) + _met_ (throw/put), while Serbian borrowed the English "football" phonetically. Both are correct — just make sure you match the room you're in. A few more that split the same way:
...
You'll notice a pattern: Serbian often drops the **-j-** that Croatian keeps (_pobeda_ vs _pobjeda_). Spot that once and you'll predict dozens of word pairs.
...
Learn a handful of these and the next time the _reprezentacija_ takes the pitch, you won't just be watching — you'll be part of the crowd. **Ajmo!**
