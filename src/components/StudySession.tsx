...
export function StudySession({ type, hintEnabled: initialHint, categoryId, wordTexts, studyDirection = "to_slavic", language = "sr" }: { type: "words" | "sentences"; hintEnabled: boolean; categoryId?: number; wordTexts?: string; studyDirection?: string; language?: string }) {
      ...
      <div className="text-center py-12 px-4">
        ...
        {studyDirection !== "to_english" && (
          <a
            ...
            className="inline-flex items-center gap-2 mt-6 text-slate-400 text-sm hover:text-slate-600 transition"
          >
