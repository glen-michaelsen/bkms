...
export const SR_PHONETICS: Record<string, LetterPhonetic> = {
  ...
  "C":  { sounds: '"ts" — both sounds run together',         think: 'The "zz" in "pi**zz**a", or "ca**ts**"' },
  ...
  "LJ": { sounds: '"ly" run together — palatal L',           think: 'The "ll" in "mi**ll**ion" or "bi**ll**ion"' },
  ...
  "Ž":  { sounds: '"zh" — the voiced "sh"',                  think: 'The "s" in "mea**s**ure" or "g" in "**g**enre"' },
}
