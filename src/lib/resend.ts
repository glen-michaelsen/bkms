      ...
      <table width="100%" style="max-width:520px;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #e2e8f0;">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#7c3aed,#a855f7);padding:32px 40px;text-align:center;">
            ...
            <h1 style="margin:12px 0 0;color:#ffffff;font-size:24px;font-weight:800;">Don't lose your streak!</h1>
          </td>
        </tr>
        <!-- Body -->
        <tr>
          <td style="padding:32px 40px;">
            ...
            <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.7;">
              You haven't practised Serbian today yet. A short session is all it takes to keep your streak alive — even just a few words!
            </p>
...
export async function sendVerbOfDay({
  ...
  const examplesHtml = examples.length ? `
    ...
    <div style="margin-bottom:12px;padding:12px 16px;background:#f8fafc;border-radius:12px;border-left:3px solid #7c3aed;">
      <p style="margin:0 0 4px;color:#1e293b;font-size:14px;font-weight:600;">${ex.serbian}</p>
  ...
  await resend.emails.send({
    from: FROM,
    to,
    subject: `Verb of the day: ${verb.infinitive} (${verb.translation}) 📚`,
    html: `
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>
      ...
      <table width="100%" style="max-width:520px;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #e2e8f0;">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#7c3aed,#a855f7);padding:32px 40px;">
            ...
            <h1 style="margin:0 0 4px;color:#ffffff;font-size:32px;font-weight:800;">${verb.infinitive}</h1>
